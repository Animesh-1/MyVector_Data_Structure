...
public interface MyList<E> {
   ...
   // The default value for your capacity variable should be 10, and the default value for your incrementCapacity variable should be 5
	...
	/**
	 * Trims the capacity of this testing.MyVector instance to be the list's current size. An application
         * can use this operation to minimize the storage of a testing.MyVector instance.
	 */
